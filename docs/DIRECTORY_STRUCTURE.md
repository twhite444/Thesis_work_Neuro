...
**Generation:**
```python
from olfactory_modeling.data.molecular_graphs import load_graph_by_cid, visualize_molecule_interactive
...
**Generation:**
```python
from olfactory_modeling.pipeline.activity_maps import load_and_mask_maps
...
# Generate graphs
from olfactory_modeling.data.molecular_graphs import generate_molecular_graphs
...
from olfactory_modeling.pipeline.preprocess import preprocess_features
...
# 4. Train model
from olfactory_modeling.pipeline.train_linear import train_linear_model
...
python -c "from olfactory_modeling.data.molecular_graphs import generate_molecular_graphs; generate_molecular_graphs('data/01_raw')"

# 4. Visualize a molecule
python -c "from olfactory_modeling.data.molecular_graphs import load_graph_by_cid; load_graph_by_cid(1183, mode='simple', projection='3d')"
