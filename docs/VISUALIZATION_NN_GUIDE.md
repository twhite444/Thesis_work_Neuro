...
**Usage:**
```python
from src.neuro_foundation.visualization import plot_prediction_scatter
import numpy as np
...
**Usage:**
```python
from src.neuro_foundation.visualization import plot_activity_map_comparison
...
**Usage:**
```python
from src.neuro_foundation.visualization import create_training_report
...
**Usage:**
```python
from src.neuro_foundation.visualization import plot_feature_importance
import pandas as pd
import torch
